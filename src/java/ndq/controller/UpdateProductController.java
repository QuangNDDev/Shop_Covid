...
import ndq.product.AddProductError;
        ...
        try {
            if (user == null) {
                ...
                if (statusUser.equals("Active")) {
                    ...
                    if (check) {
                        ProductDTO product = new ProductDTO(productID, productName, fileName, category, status, Integer.parseInt(quantity), Float.parseFloat(price));
                        ...
                        ProductDTO product = new ProductDTO(productID, productName, fileName, status);
